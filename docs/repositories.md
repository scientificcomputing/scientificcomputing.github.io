...
- [The latent variable proximal point algorithm for variational problems with inequality constraints](https://github.com/METHODS-Group/ProximalGalerkin) {cite}`dokken2025latentvariableproximalpoint`
